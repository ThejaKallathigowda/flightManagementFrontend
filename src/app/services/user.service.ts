...
export class UserService {
  ...
  */
  ...
  searchFlight2way(from,to,departdate,returndate): Observable<any>{
    return this.http.get<any>(`${this.baseUrl}/findFlightRoundTrip/${to}/${from}/${departdate}/${returndate}`).pipe(
      catchError(this.errorHandler)
    );
  }
